...
/**
 * Jersey REST client generated for REST resource:HistorialCampaniaFacadeREST
 * [ec.edu.espe.entities.historialcampania]<br>
 * USAGE:
 * <pre>
 ...
 * @author homer
 */
public class HistorialCampaniaRestClient {
...
//   private static final String BASE_URI = "http://localhost:34488/PublicidadWebHitchUs/webresources";
    ...
    public HistorialCampaniaRestClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("historialcampania");
    }
    ...
    public void edit_JSON(HistorialCampania requestEntity, Integer id) throws ClientErrorException {
    ...
    public <HistorialCampania> HistorialCampania find_JSON(Class<HistorialCampania> responseType, Integer id) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public void create_JSON(HistorialCampania requestEntity) throws ClientErrorException {
    ...
    public HistorialCampania[] findAll_JSON() throws ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(HistorialCampania[].class);
    }
