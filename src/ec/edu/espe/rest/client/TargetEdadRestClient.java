...
/**
 * Jersey REST client generated for REST resource:TargetEdadFacadeREST
 * [ec.edu.espe.entities.targetedad]<br>
 * USAGE:
 * <pre>
 ...
 * @author homer
 */
public class TargetEdadRestClient {
    ...
    public TargetEdadRestClient() {
        ...
        webTarget = client.target(BASE_URI).path("targetedad");
    }
    ...
    public void edit_JSON(TargetEdad requestEntity, String id) throws ClientErrorException {
        webTarget
                .path("edit/"+id)
    ...
    public <TargetEdad> TargetEdad find_JSON(Class<TargetEdad> responseType, String id) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public void create_XML(TargetEdad requestEntity) throws ClientErrorException {
        webTarget
                .request(javax.ws.rs.core.MediaType.APPLICATION_XML)
                .post(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_XML));
    }

    public void create_JSON(TargetEdad requestEntity) throws ClientErrorException {
    ...
    public TargetEdad[] findAll_JSON() throws ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(TargetEdad[].class);
    }
