...
public class UsuarioRestClient {
    ...
    public void edit_JSON(Usuario requestEntity, Integer id) throws ClientErrorException {
        webTarget
                .path("edit/"+id)
    ...
    public <Usuario> Usuario find_JSON(Class<Usuario> responseType, Integer id) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public void create_XML(Object requestEntity) throws ClientErrorException {
        webTarget
                .request(javax.ws.rs.core.MediaType.APPLICATION_XML).post(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.APPLICATION_XML));
    }

    public void create_JSON(Usuario requestEntity) throws ClientErrorException {
    ...
    public Usuario[] findAll_JSON() throws ClientErrorException {
        WebTarget resource = webTarget;
