...
import ec.edu.espe.models.SegmentoDetalleCampania;

/**
 * Jersey REST client generated for REST
 * resource:SegmentoDetalleCampaniaFacadeREST
 * [ec.edu.espe.entities.segmentodetallecampania]<br>
 * USAGE:
 * <pre>
 ...
 * @author homer
 */
public class SegmentoDetalleCampaniaRestClient {
    ...
    public SegmentoDetalleCampaniaRestClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("segmentodetallecampania");
    }
    ...
    public void edit_JSON(SegmentoDetalleCampania requestEntity, String id) throws ClientErrorException {
    ...
    public <SegmentoDetalleCampania> SegmentoDetalleCampania find_JSON(Class<SegmentoDetalleCampania> responseType, String id) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public void create_JSON(SegmentoDetalleCampania requestEntity) throws ClientErrorException {
    ...
    public SegmentoDetalleCampania[] findAll_JSON() throws ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(SegmentoDetalleCampania[].class);
    }
