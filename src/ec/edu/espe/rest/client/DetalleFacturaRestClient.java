...
import ec.edu.espe.models.DetalleFactura;

/**
 * Jersey REST client generated for REST resource:DetalleFacturaFacadeREST
 * [ec.edu.espe.entities.detallefactura]<br>
 * USAGE:
 * <pre>
 *        DetalleFacturaRestClient client = new DetalleFacturaRestClient();
 ...
 * @author homer
 */
public class DetalleFacturaRestClient {
    ...
    public DetalleFacturaRestClient() {
        ...
        webTarget = client.target(BASE_URI).path("ec.edu.espe.entities.detallefactura");
    }
    ...
    public void edit_JSON(DetalleFactura requestEntity, Integer id) throws ClientErrorException {
        webTarget
                .path("edit/"+id)
    ...
    public <DetalleFactura> DetalleFactura find_JSON(Class<DetalleFactura> responseType, Integer id) throws ClientErrorException {
        WebTarget resource = webTarget;
    ...
    public void create_JSON(DetalleFactura requestEntity) throws ClientErrorException {
    ...
    public DetalleFactura[] findAll_JSON() throws ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(DetalleFactura[].class);
    }
